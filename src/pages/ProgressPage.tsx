...
export function ProgressPage() {
	...
	return <section>
		<PageIntro eyebrow="The progress ledger" title="Seventy-seven solved, eight months in." description="A ledger of the questions you have carried from uncertainty to working knowledge." />
		<div className="panel"><div className="panel-heading"><div><span className="eyebrow">Last 60 days</span><h2>Activity</h2></div><span className="mono">0 — 5+</span></div><ActivityHeatmap /></div>
